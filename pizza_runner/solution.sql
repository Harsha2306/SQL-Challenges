...
-- Copy customer_orders to new table and clean 'null' strings
...
-- Copy runner_orders to new table and clean/standardize
...
select count(*) pizzas_ordered from customer_orders1;